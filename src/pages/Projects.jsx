...
const portfolioData = [
  {
    ...
    btn1: "",
    btn2: "",
    hoverDescription: "Tech: React, Node.js, GIS Mapping, Machine Learning integration.",
  },
  {
    ...
    btn1: "",
    btn2: "",
    hoverDescription: "Tech: MERN Stack, Chart.js, WebSockets for real-time data.",
  },
  {
    category: "GenAI & API",
  ...
  },
  {
    ...
    imageUrl: "https://placehold.co/600x400/2563eb/ffffff?text=Video+Conferencing",
    btn1: "",
    btn2: "",
...
const Projects = () => {
  return (
    ...
    {portfolioData.map((link, index) => (
      <div key={index} className="flex flex-col gap-3 rounded-[10px] bg-[#141414e6] p-4 ">
          ...
          <button className="bg-gray-900/50 px-6 py-2 rounded-[10px] cursor-pointer">Code</button>
          <button className="bg-gray-900/50 px-6 py-2 rounded-[10px] cursor-pointer">Link</button>
          </div>
        </div>
      ))}
        </div>
